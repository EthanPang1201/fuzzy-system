 ...
 * @Description: 加密解密算法
 * @author: GuoqingPang
 * @date: 2017年8月5日 下午12:16:04
 * 
 * @Copyright: 2017 Ethan.Pang Inc. All rights reserved. 注意：本内容仅做毕业设计用。
 */
public class DESEncryptUtil {
	...
	private static final String KEY = "ethan.pang+1201+alline+0221";

	/**
	 * @Title: encryption
	 * @Description: DES加密
	 * @param: @param plainData
...
//		String input = "123456";
//
//		String result = DESEncryptUtil.encryption(input);
//		System.out.println(result);
//
//		System.out.println(DESEncryptUtil.decryption(result));
//	}
}